const testimonials_data=[
    {
        ...
        dp:'https://imgs.search.brave.com/evunsPaH9enOCtlFLxDnLbA6zkRMxcbnHFRj9kVlBQQ/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9zdGF0/aWMxLm1vdmlld2Vi/aW1hZ2VzLmNvbS93/b3JkcHJlc3Mvd3At/Y29udGVudC91cGxv/YWRzLzIwMjIvMDkv/RG9sb3Jlcy1VbWJy/aWRnZS5qcGc',
        ...
        (ARMSCON 2024) from November 14th to 16th, 2024. The students are\n
    ...
    },
    {
        ...
        shortdata:`I am thrilled to endorse the upcoming edition of ARMSCON. The
        conference promises to be a hub of knowledge and innovation. With
        renowned speakers, informative workshops, and engaging sessions,
        attendees will have the opportunity to expand their understanding of the
        medical field and stay up-to-date with the latest advancements.
        Additionally, the inclusion of cultural activities adds an exciting
        dimension to the event, allowing participants to immerse themselves in
        the rich diversity of our community.`,
        longdata:`I am thrilled to endorse the upcoming edition of ARMSCON. The
        conference promises to be a hub of knowledge and innovation. With
        renowned speakers, informative workshops, and engaging sessions,
        attendees will have the opportunity to expand their understanding of the
        medical field and stay up-to-date with the latest advancements.
        Additionally, the inclusion of cultural activities adds an exciting
        dimension to the event, allowing participants to immerse themselves in
        the rich diversity of our community. I would like to express my gratitude
        to the organizers for their hard work and dedication in creating such a
        comprehensive and inclusive conference. I have no doubt that this event
        will be a resounding success, fostering collaborations, inspiring creativity,
        and nurturing the holistic development of medical professionals.`
    },
    {
    ...
    {
        name:'Dr. M.G. Vashishth',
        dp:'',
        position:`Dean Students’ Welfare
        Pt. B.D. Sharma UHS`,
        shortdata:`ARMSCON is a fantastic opportunity for our students to showcase their
        talent, learn from experts in the medical field, and immerse themselves in
        a diverse cultural experience. The conference offers a perfect balance
        between academic enrichment and cultural exploration. Our delegates
        will have access to insightful lectures, interactive workshops and
        engaging panel discussions that will broaden their understanding of
        medicine and inspire them to excel in their chosen fields.`,
        longdata:`ARMSCON is a fantastic opportunity for our students to showcase their
        talent, learn from experts in the medical field, and immerse themselves in
        a diverse cultural experience. The conference offers a perfect balance
        between academic enrichment and cultural exploration. Our delegates
        will have access to insightful lectures, interactive workshops and
        engaging panel discussions that will broaden their understanding of
        medicine and inspire them to excel in their chosen fields. The inclusion of
        cultural activities adds an exciting element, allowing our students to
        celebrate their heritage and appreciate the rich tapestry of our
        community. I have no doubt that this conference will be a resounding
        success, that the students will cherish forever.`
    }
]
